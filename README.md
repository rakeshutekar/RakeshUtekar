...
<!-- ============ CONTRIBUTION-GRAPH PAC-MAN ============
  Generated by .github/workflows/arcade-graph.yml, served from the `output`
  branch. Pac-Man eats the contribution calendar; dark/light auto-selected. -->
<h2 align="center">🟡 Watch Pac-Man eat my contributions</h2>
<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/rakeshutekar/RakeshUtekar/output/pacman-contribution-graph-dark.svg" />
    <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/rakeshutekar/RakeshUtekar/output/pacman-contribution-graph.svg" />
    <img alt="Pac-Man eating my GitHub contribution graph" src="https://raw.githubusercontent.com/rakeshutekar/RakeshUtekar/output/pacman-contribution-graph.svg" />
  </picture>
</p>
